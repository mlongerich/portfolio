    ...
    <div className="diagram-mobile">
      ...
      >
        ...
        <g className="layer-arrows">
          <MArr id="clients-tech" d="M 70 1140 C -30 1140, -30 110, 110 110" revealedArrows={revealedArrows} />
          <MArr id="comm-tech"    d="M 200 1140 C 430 1140, 430 110, 290 110" revealedArrows={revealedArrows} />
          ...
          <MArr id="comm-ment"    d="M 330 1064 L 330 1140" revealedArrows={revealedArrows} />
          <MArr id="speak-comm"   d="M 50 937 C -20 1020, -20 1100, 170 1140" revealedArrows={revealedArrows} dashed />
        </g>

        {/* Pulses */}
        <g className="layer-pulses">
          <MPulse arrowId="clients-tech" dur="3.4s" begin="0s"   revealedArrows={revealedArrows} />
          <MPulse arrowId="comm-tech"    dur="4.0s" begin="0.4s" revealedArrows={revealedArrows} />
          ...
          <MPulse arrowId="comm-ment"    dur="8.0s" begin="0s"   revealedArrows={revealedArrows} />
          <MPulse arrowId="speak-comm"   dur="6.4s" begin="0.5s" revealedArrows={revealedArrows} />
        </g>
        ...
        <g className="layer-nodes">
          <NodeGrp nodeId="tech-lead" ariaLabel="Tech Leadership" {...nodeProps}>
            ...
            <text className="node-sub" x="34" y="166" fontSize="10">Squad of 20 · Thoughtworks · since 2020</text>
          ...
          <NodeGrp nodeId="dashnote" ariaLabel="Dashnote" {...nodeProps}>
            <rect className="node-rect" x="24" y="656" width="352" height="72" rx="5" />
            <text className="node-id" x="34" y="674" fontSize="9">pod/dashnote</text>
            <text className="node-title" x="34" y="694" fontSize="13">Dashnote</text>
          ...
          <NodeGrp nodeId="pfa-app" ariaLabel="PFA Donation App" {...nodeProps}>
            <rect className="node-rect" x="24" y="742" width="352" height="72" rx="5" />
            <text className="node-id" x="34" y="760" fontSize="9">pod/pfa-app</text>
            <text className="node-title" x="34" y="780" fontSize="13">PFA Donation App</text>
        ...
        {/* External actors (positioned below the system) */}
        <g className="layer-actors">
          <g className={cl('external prov-fade', r('actor-clients') && 'in')} data-prov="actor-clients">
            <rect className="actor-box" x="14" y="1140" width="112" height="40" rx="4" />
            <text className="actor-id" x="22" y="1154" fontSize="7.5">{'{ external }'}</text>
            <text className="actor-title" x="22" y="1168" fontSize="10">Clients</text>
          </g>
          <g className={cl('external prov-fade', r('actor-community') && 'in')} data-prov="actor-community">
            <rect className="actor-box" x="144" y="1140" width="112" height="40" rx="4" />
            <text className="actor-id" x="152" y="1154" fontSize="7.5">{'{ external }'}</text>
            <text className="actor-title" x="152" y="1168" fontSize="10">Community</text>
          </g>
          <g className={cl('external prov-fade', r('actor-mentees') && 'in')} data-prov="actor-mentees">
            <rect className="actor-box" x="274" y="1140" width="112" height="40" rx="4" />
            <text className="actor-id" x="282" y="1154" fontSize="7.5">{'{ external }'}</text>
            <text className="actor-title" x="282" y="1168" fontSize="10">Mentees</text>
          </g>
        </g>
        ...
        <g className="layer-arrow-labels" aria-hidden="true">
          ...
          <g className="arrow-label-group" data-arrow="speak-comm"><text className="arrow-label" x="-32" y="540" fontSize="9" textAnchor="start">broadcasts</text></g>
        </g>
        ...
        <g>
          ...
          <text className={cl('namespace-label prov-fade', r('footer-2') && 'in')} data-prov="footer-2" x="20" y="1116" fontSize="8">
            <tspan className="key">▸</tspan> <tspan fill="var(--text-muted)">tap any node to inspect</tspan>
          </text>
        </g>
      </svg>
    </div>
